...
class The7_Core_Compatibility {
	...
	public static function display_outdated_plugin_notice() {
		...
		<div class="the7-dashboard-notice the7-notice notice notice-error">
			<p>
				<?php echo wp_kses_post( sprintf( __( '<strong>Important notice</strong>: You have an outdated version of <strong>The7 Elements</strong> plugin. For better compatibility with the theme it is required to <a href="%s">update the plugin</a>.', 'the7mk2' ), admin_url( 'admin.php?page=the7-plugins' ) ) ); ?>
			</p>
		</div>
		<?php
	}
