...
<div class="aegis-t-a4">
    ...
    <?php if (!$shipment) : ?>
        <form method="post" class="aegis-t-a5" style="margin:12px 0;">
            ...
            <label class="aegis-t-a6" style="margin-left:12px;">备注（可选）：<input type="text" name="note" /></label>
            <p style="margin-top:10px;"><button type="submit" class="button button-primary">开始出库</button></p>
        </form>
    <?php else : ?>
