...
<div class="aegis-portal-shell">
    <div class="aegis-system-root aegis-portal-root aegis-t-a5<?php echo $is_warehouse_mode ? ' is-warehouse-mode' : ''; ?>">
        <header class="aegis-portal-topbar">
            <div class="aegis-portal-topbar-left aegis-portal-branding">
                ...
                <img class="aegis-portal-brand" src="<?php echo esc_url(AEGIS_SYSTEM_URL . 'assets/img/logo_red.svg'); ?>" alt="AEGISMAX" />
            </div>
            <div class="aegis-portal-topbar-center">
                <div class="aegis-portal-title">
                    <span class="aegis-portal-title-line aegis-portal-title-main">AEGISMAX 管理系统</span>
                    <span class="aegis-portal-title-line aegis-portal-title-sub">AEGIS SYSTEM · V2026版</span>
                </div>
            </div>
            <div class="aegis-portal-topbar-right">
