...
class AEGIS_System {
    ...
    public function register_admin_menu() {
        ...
        if (AEGIS_System_Roles::user_can_manage_warehouse() && (!empty($states['sku']) || !empty($states['dealer_master']) || !empty($states['codes']) || !empty($states['shipments']))
        ) {
            $has_visible = true;
        }
...
class AEGIS_System_Schema {
    ...
    protected static function get_table_sql($charset_collate) {
        ...
        return [$audit_sql, $media_sql, $sku_sql, $dealer_sql, $code_batch_sql, $code_sql, $shipment_sql, $shipment_item_sql];
    }
