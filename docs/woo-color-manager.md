...
- 通过后台“作用范围”开关控制是否扩展到全站（默认仅 Woo 主内容区 + mini cart）。
...
- 作用范围开关：默认仅 Woo 主内容区 + mini cart；全站模式会影响 header/footer。 【F:wp-content/plugins/aegis-woo-color-manager/aegis-woo-color-manager.php†L45-L207】
